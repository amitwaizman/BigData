...
exports.DBranches = function DBranches() {
...
exports.Orders = function Orders(ArraysBranch, ArraysNumBranch, ArraysArea, ArraysTopping) { /* Date */
    function today() {
        date = new Date()
    ...
    let randomOrders = `{"Branche_Name": "${
        _Branche[0]
    }", "Area:${_Area}","status: ${_status}","Open/Close":"${_bol}","Date": "${
        today()
    }", "Branche_Number": "${_BrancheNum}", "Topping": "${_Top})}", "Number_Order": ${_NumOrder}}`;
    return randomOrders
}
