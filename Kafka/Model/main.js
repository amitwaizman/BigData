...
exports.DBranches = function DBranchs() { return _fetch.Details_Branch }
...
if(dict[_Branch[0]][0]!="open"||dict[_Branch[0]][0]!="close"){
   ...
   // console.log(randomNumber);
    if(randomNumber>=0 && randomNumber<=3){
        dict[_Branch[0]][0]={0:"close"};
    }else{
        dict[_Branch[0]][0]={0:"open"}; 
    }
...
function status(){
    ...
    dict[_Branch[0]].push({1:[_NumOrder, "in process"]});
    return  _NumOrder;
}
